...
from application.issue_aplication.dataclases import IssueUser, IssueBook, BaseModel
from application.issue_aplication.interfaces import IssueRepositoryInterface


@component
class SQLBaseRepository(IssueRepositoryInterface, BaseRepository):
    model: BaseModel
    default_limit: int
...
@component
class IssueUserRepository(SQLBaseRepository):
    model: IssueUser
    default_limit: int


@component
class IssueBookRepository(SQLBaseRepository):
    model: IssueBook
    default_limit: int
